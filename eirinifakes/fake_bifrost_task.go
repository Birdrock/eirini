...
func (fake *FakeBifrostTask) TransferTask(arg1 context.Context, arg2 string, arg3 cf.TaskRequest) error {
...
func (fake *FakeBifrostTask) TransferTaskCallCount() int {
	fake.transferTaskMutex.RLock()
	defer fake.transferTaskMutex.RUnlock()
	return len(fake.transferTaskArgsForCall)
}

func (fake *FakeBifrostTask) TransferTaskCalls(stub func(context.Context, string, cf.TaskRequest) error) {
	fake.transferTaskMutex.Lock()
	defer fake.transferTaskMutex.Unlock()
	fake.TransferTaskStub = stub
}

func (fake *FakeBifrostTask) TransferTaskArgsForCall(i int) (context.Context, string, cf.TaskRequest) {
	fake.transferTaskMutex.RLock()
	defer fake.transferTaskMutex.RUnlock()
...
func (fake *FakeBifrostTask) TransferTaskReturns(result1 error) {
	fake.transferTaskMutex.Lock()
	defer fake.transferTaskMutex.Unlock()
...
func (fake *FakeBifrostTask) TransferTaskReturnsOnCall(i int, result1 error) {
	fake.transferTaskMutex.Lock()
	defer fake.transferTaskMutex.Unlock()
	fake.TransferTaskStub = nil
...
func (fake *FakeBifrostTask) Invocations() map[string][][]interface{} {
...
func (fake *FakeBifrostTask) recordInvocation(key string, args []interface{}) {
...
var _ eirini.BifrostTask = new(FakeBifrostTask)
